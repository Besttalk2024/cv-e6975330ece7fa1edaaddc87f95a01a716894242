...
class SymbolInfo {
    constructor(options) {
        ...
        console.log(this,'SymbolInfoSymbolInfoSymbolInfo');
    }
}
...
class DataFeed {
    ...
    resolveSymbol(
        ...
        Promise.all([
            ...
            .then(assets => {
                console.log(assets,'assetsassetsassetsassetsassetsassets');
    ...
    getBars(
        ...
        console.log(this,'getBarsgetBarsgetBars');
        console.log({from, to, resolution, symbolInfo, firstDataRequest },'getBarsgetBarsgetBars____');
        from *= 1000;
        to *= 1000;
    ...
    subscribeBars(
        ...
        console.log(symbolInfo,resolution,subscriberUID,'subscribeBarssubscribeBars');
